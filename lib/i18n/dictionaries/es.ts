...
const es: Dictionary = {
  ...
  landing: {
    ...
    recover: {
      toggle: "¿Ya tienes una lista? Recupérala por correo",
      title: "Recupera tu lista",
      subtitle: "Introduce el correo con el que la creaste.",
      emailLabel: "Tu correo electrónico",
      emailPlaceholder: "tu@ejemplo.com",
      submit: "Buscar mi lista",
      submitting: "Buscando…",
      cancel: "Cancelar",
      foundTitle: "Aquí tienes tu lista",
      foundBody: "Este es tu enlace privado de edición para {email}.",
      linkLabel: "Enlace de edición",
      copyButton: "Copiar enlace",
      copiedButton: "¡Copiado!",
      goToList: "Ir a tu lista",
      tryAnother: "Probar con otro correo",
      notFoundBody: "No encontramos ninguna lista activa para {email}.",
      errors: {
        email: "Introduce un correo electrónico válido.",
        generic: "Algo salió mal. Inténtalo de nuevo en un momento.",
      },
  ...
  edit: {
    ...
    items: {
      ...
      privateBadge: "Solo visible para ti",
      markPurchasedButton: "Marcar como comprado",
      undoPurchaseButton: "Deshacer compra",
      makePrivateButton: "Solo visible para mí",
      makePublicButton: "Mostrar en la lista compartida",
      ...
      sections: {
        ...
        private: "Solo visible para ti ({count})",
      },
    },
    editLinkWarning:
