...
export function IconHeart({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 21s-7.2-4.6-9.9-9C.4 8.4 1.7 4.7 5 4c2-.4 3.9.5 5 2.2C11.1 4.5 13 3.6 15 4c3.3.7 4.6 4.4 2.9 8-2.7 4.4-9.9 9-9.9 9Z" />
    </svg>
  );
}
...
export function IconSparkle({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2c.6 3.6 2 6.4 4.5 7.5C14 10.6 12.6 13.4 12 17c-.6-3.6-2-6.4-4.5-7.5C10 8.4 11.4 5.6 12 2Z" />
      <path d="M19 13c.3 1.7 1 2.9 2 3.5-1 .6-1.7 1.8-2 3.5-.3-1.7-1-2.9-2-3.5 1-.6 1.7-1.8 2-3.5Z" />
    </svg>
  );
}
